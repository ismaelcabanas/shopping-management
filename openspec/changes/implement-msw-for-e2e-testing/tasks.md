...
- [ ] 2.2 Implement Gemini API mock handler
...
- [ ] 2.3 Create MSW setup for Playwright
...
- [ ] 4.2 Update US-008 E2E test (if exists)
  - Apply same MSW migration
  - Remove E2E mode flags
  - Verify test passes

- [ ] 4.3 Update any other E2E tests
...
- [ ] 5.1 Clean up ProductCatalogPage
